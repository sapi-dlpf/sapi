...
def obter_quesitos_padroes():
    ...
    while True:
        ...
        solicitacao = texto('Quesitos que ocorreram no mínimo',
...
class DialogoParametrosBuscaLaudo(tkinter.Frame):
    ...
    def initUI(self):
        ...
        self.entry_data_inicial.insert(tkinter.END, "01/01/2016")
        self.entry_data_inicial.pack(anchor=tkinter.W)

        # Data Final
        ttk.Label(self, text="").pack(anchor=tkinter.W)
        ttk.Label(self, text="Data de emissão final dos laudos:").pack(anchor=tkinter.W)
...
def localiza_um_quesito(quesito, texto, reduzir):
    ...
    tamanho_minimo = int(len(quesito)/2)
...
def comparacao_quesito_texto(quesitos, texto):
    ...
    # Separa em quesitos
    lista_quesitos = quesitos.split('\n')

    q_ini=None
    q_fim=None
    tam_quesitos_total=0
    for q in lista_quesitos:
    ...
    if pos_ini is not None:
        ...
        print("Localizou quesito inicial")
    ...
    print("pos_ini_texto")
    var_dump(pos_ini_texto)

    print("pos_fim_texto")
    var_dump(pos_fim_texto)
    ...
    if pos_ini_texto is not None:
        ...
        (diff_merge, diff_ops) = diff_textos(quesitos, subtexto)
        print(diff_merge)
        print(diff_ops)
    ...
    return (taxa_similaridade, diff_merge, diff_ops)


def compara_quesitos_com_solicitacao(texto_solicitacao):
    ...
    for k_qr in Gmod_quesitos_respostas:
        ...
        (taxa_similaridade, diff_merge, diff_ops) = comparacao_quesito_texto(texto_quesitos, texto_solicitacao)
...
def teste_texto_solicitacao():

    texto_solicitacao = (
    '                                                                                                                    '
    'DPF/i\n'
    '^a terlai\n'
    '3549/16     telefone   celular 2\n'
    '\n'
    '\n'
    'fiío}\n'
    '\n'
    '\n'
    'teu é*Ja^/-:líl. a                                   SERVIÇO PÚBLICO '
    'FEDERAL\n'
    'Memorando    1259/18-DPF/CftC/PR\n'
    '\n'
    '                                                       MJ - POLÍCIA FEDERAL\n'
    '                                        SR/PR - DELEGACIA DE POLÍCIA FEDERAL '
    'EM CASCAVEL\n'
    '                                   Rua Paraná, 1264, Centro, Cascavei/PR - '
    'CEP: 85.812-010 - Telefone: (45) 3036-6400\n'
    '\n'
    '\n'
    '                        Memorando n° K-1259/2018 - IPL 0288/2018-4 '
    'DPF/CAC/PR\n'
    '                                                                                     '
    'CascaveI/PRt 05 de junho de 2018.\n'
    '\n'
    '                       A Sua Senhoria o Senhor\n'
    '                       Perito Criminal Federal\n'
    '                       Chefe do SETEC/SR/PF/PR\n'
    '\n'
    '\n'
    '                                                                                                       '
    'INDICIADO PRESO\n'
    '                       Assunto. Solicita Exame Pericial em Celulares\n'
    '                       Refeiência: IPL n° 0288/2018-4-DPF/CAC/PR\n'
    '\n'
    '                                      Senhor Perito,\n'
    '\n'
    '                                    Visando instruir Inquérito Policial, '
    'Solicito a Vossa Senhoria de que seja\n'
    '                       realizado o competente exame pericial no(s) '
    'aparelho(s) de telefonia celular\n'
    '                       constante(s) no(s) item(ns) 4 e 5, do Auto de '
    'Apresentação e Apreensão (cópia\n'
    '                       anexa), devendo responder aos seguintes quesitos-\n'
    '\n'
    '                                  Qual a natureza dos equipamentos '
    'apresentados para exame?\n'
    '                                  Quais os números telefônicos de '
    'habilitação dos aparelhos questionados?\n'
    '                       lil        E possível determinar a quem pertencem?\n'
    '                       IV.        Quais os números discados constantes na '
    'memória dos aparelhos?\n'
    '                       V.         Quais as chamadas recebidas constantes na '
    'memória dos aparelhos?\n'
    '                       VI.        Qual a relação de nomes e telefones '
    'constantes na agenda eletrônica dos\n'
    '                              aparelhos?\n'
    '                                  Quais as mensagens de texto enviadas '
    'constantes na memória dos aparelhos?\n'
    '                             I.   Quais as mensagens de texto recebidas '
    'constantes na memória dos aparelhos?\n'
    '                       IX.        Existem chamadas ou mensagens de texto '
    'trocadas entre os numerais\n'
    ...
    'Matricula n° 10.030\n'
    '\n'
    '                                            Ao responder este expediente, '
    'favor informar o número do IPLÍ\n'
    '\n'
    '\n'
    '\n'
    '\n'
    ...
    '                              SERVIÇO PÚBLICO FEDERAL\n'
    '                                  MJ " POLÍCIA FEDERAL\n'
    '                                 r?££?i                  ERAL EM CASCAVEL\n'
    '                                 Cascavei/PR - CEP: 85.812*010- Telefone: '
    '(46) 3036-6400\n'
    '\n'
    '\n'
    '                   AUTO DE APRESENTAÇÃO E APREENSÃO\n'
    '                            ÍPL n° 0288/2018-4 - DPF/CAC/PR\n'
    '\n'
    "                    ^e JUnh° de 2°18' nesta DELEGACIA DE POLÍCIA FEDERAL\n"
    '              PollcS\n'
    "              Policia S«e'/PRl      °nde 96daenC°ntraVa\n"
    '                      Federal, na presença              ORNANDO\n'
    '                                               testemunha ROBSON FARIA\n'
    '                                                                 ROSA DE S\n'
    "               aíAF!RESENTANTE 6 PR'MEIRA TCSTEMUNHTjÍf\n"
    '                            apnBendidO(Mína forma da ímÍ:\n'
    '\n'
    'AfireensâpjT^04y2018\n'
    ' jtem Descrição\n'
    '                                                            Observai\n'
    '      Telefone Celular                              UN      Marca SAMSUNG, '
    'modelo\n'
    '                                                            SM-G6107DS, cor '
    'preto com\n'
    '                                                            azul escuro, '
    ...
    'ÁLVARO\n'
    '                                                           BALBINOT.\n'
    '                                      em poder de VANDERSON CORDEIRO APPELT\n'
    '                    , conforme auto de prisào em flagrante. <Os documentos '
    'e\n'
    '                          --loais dos presos foram entregues a eles '
    'próprios,\n'
    '                           ropriedade> Nada mais havendo, determinou a '
    'autoridade\n'
    '                                          e achado conforme, vai por iodos '
    'assinado\n'
    '                                          VINÍCIUS\n'
    '\n'
    '\n'
...
def teste3():
    ...
    caminho_template = "D:/Exames_andamento/documentos_produzidos/laudo_modelo_sapi_SETEC_PR_v2_3_01b.odt"
    ...
    for codigo in lista:
        gui_teste3_uma_solicitacao(codigo)
...
def gui_teste3_uma_solicitacao(codigo):
    ...
    texto_solicitacao=str(dados['texto_solicitacao']).strip()
    if texto_solicitacao=="":
        print(codigo)
        print("Solicitação sem texto")
        return
    ...
    if k_quesito_similar is None:
        print("Não foi possível localizar nenhum quesito com similaridade superior a", menor_taxa_similaridade_aceita)
    else:
        qr = Gmod_quesitos_respostas[k_quesito_similar]
        taxa_similaridade=qr['taxa_similaridade']
        texto_quesitos=qr['texto_quesitos']
        print("="*100)
        print_console(texto_quesitos)
        print()
        print("taxa_similaridade:", taxa_similaridade)
        print("="*100)
        print()
...
def teste3_uma_solicitacao(codigo):
...
# Limpeza após final de documento
def teste4():

    sapisrv_inicializar_ok(Gprograma, Gversao, auto_atualizar=True)
    caminho_template = "C://Users//PCF-//Downloads//Laudo_1805_2018_SETEC_SR_PF_PR_sapi.odt"
    carrega_valida_modelo(caminho_template)
    die('ponto6905')

# Isto aqui é para criptografa o sapí.info
# O intuito é levar para o sapi_cellebrite
# Assim, não tem problema deixar o arquivo sapi.info na pasta
# Este arquivo contém o caminho para a pasta do servidor...não é bom que isto fique público
def teste5():
